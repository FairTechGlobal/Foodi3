		...
		<!-- header-starts -->
									...
									<ul class="nofitications-dropdown">
											<li class="dropdown note dra-down">
													   <div id="dd" class="wrapper-dropdown-3" tabindex="1">
																			<span>Kenya</span>
																			<ul class="dropdown">
																				<li><a class="deutsch">Uganda</a></li>
																				<li><a class="english"> Tanzania</a></li>
																				<li><a class="espana">South Africa</a></li>
																				<li><a class="russian">Nigeria</a></li>
																				<li><a class="deutsch">Kenya</a></li>
			...
			<!--/sidebar-menu-->
				<div class="sidebar-menu">
					<header class="logo">
					<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="index.html"> <span id="logo"> <h1>Foodi3</h1></span> 
