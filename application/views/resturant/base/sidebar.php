		<!--/sidebar-menu-->
				<div class="sidebar-menu">
					<header class="logo">
					<a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="<?php echo base_url('index.php/Resturant/index');?>"> <span id="logo"> <h1>Foodi3</h1></span> 
			...
			<!--/down-->
							<div class="down">	
									  <a href="index.html"><img src="<?php echo base_url('./assets/images/in3.jpg');?>"></a>
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="<?php echo base_url('index.php/Resturant/dashboard');?>"><i class="fa fa-tachometer"></i> <span>Dashboard</span></a></li>
										 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span>Add</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
											<li id="menu-academico-avaliacoes" ><a href="<?php echo base_url('index.php/Resturant/addadmin');?>">Add Admin</a></li>
											<li id="menu-academico-avaliacoes" ><a href="<?php echo base_url('index.php/Resturant/adduser');?>">Add User</a></li>
										 ...
										 <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>Company Profile</span> <span class="fa fa-angle-right" style="float: right"></span></a>
											 <ul id="menu-academico-sub" >
												<li id="menu-academico-avaliacoes" ><a href="<?php echo base_url('index.php/Resturant/create');?>">Create</a></li>
												<li id="menu-academico-boletim" ><a href="<?php echo base_url('index.php/Resturant/update');?>">Update</a></li>
											  </ul>
										 </li>
									<!-- <li><a href="typography.html"><i class="lnr lnr-pencil"></i> <span>Typography</span></a></li> -->
									<li id="menu-academico" ><a href="#"><i class="lnr lnr-book"></i> <span>Jobs</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										  <ul id="menu-academico-sub" >
										    <li id="menu-academico-avaliacoes" ><a href="<?php echo base_url('index.php/Resturant/update');?>">Post Job</a></li>
										    <li id="menu-academico-boletim" ><a href="<?php echo base_url('index.php/Resturant/update');?>">View Jobs</a></li>
											<li id="menu-academico-boletim" ><a href="<?php echo base_url('index.php/Resturant/update');?>">Update Job</a></li>
									 ...
									 <li><a href="#"><i class="lnr lnr-envelope"></i> <span>Mail Box</span><span class="fa fa-angle-right" style="float: right"></span></a>
									   <ul>
										<li><a href="<?php echo base_url('index.php/Resturant/inbox');?>"><i class="fa fa-inbox"></i> Inbox</a></li>
										<li><a href="<?php echo base_url('index.php/Resturant/compose');?>"><i class="fa fa-pencil-square-o"></i> Compose Mail</a></li>
